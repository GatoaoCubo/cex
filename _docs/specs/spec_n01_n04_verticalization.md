...
tldr: "N01 evolves to Research Analyst (Analytical Envy). N04 evolves to Knowledge Engineer (Knowledge Gluttony + database layer). FULL scope: 6 schemas + 8 outputs each."
density_score: 0.95
quality: 9.1
updated: "2026-04-07"
---
...
- N04: Knowledge Engineer — Knowledge Gluttony + database layer + fine-tuning/ML prep
