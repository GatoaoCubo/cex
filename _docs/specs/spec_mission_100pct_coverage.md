...
3. Enough instances exist to justify builder overhead (12 ISOs per kind)
...
| Builder scaffold (12 ISOs) | 12 | N03 | manifest, instruction, system_prompt, schema, few_shot, quality_gate, golden_test, etc. |
