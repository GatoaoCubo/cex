...
## Purpose
Master index of all 20 kinds in pillar P03. Reference for /mentor, nucleus builders, and the 8F pipeline.
...
## CoC Hierarchy Note
These 20 kinds follow the convention-over-configuration hierarchy: each instance
