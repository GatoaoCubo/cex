...
## Purpose
Master index of all 19 kinds in pillar P10. Reference for /mentor, nucleus builders, and the 8F pipeline.
...
| `user_model` | Cross-session dialectic user representation (Honcho pattern, HERMES) | N04 | `user-model-builder` |
...
## CoC Hierarchy Note
These 19 kinds follow the convention-over-configuration hierarchy: each instance
