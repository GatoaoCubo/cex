...
## Purpose
Master index of all 35 kinds in pillar P04. Reference for /mentor, nucleus builders, and the 8F pipeline.
...
| `messaging_gateway` | Multi-platform messaging transport (TG/Discord/Slack/WhatsApp/Signal/Email) HERMES | N05 | `messaging-gateway-builder` |
...
|----------|-------------|-------|
| [[kc_intent_resolution_map]] | sibling | 0.48 |
...
| [[self_audit_n05_codex_2026_04_15]] | downstream | 0.26 |
| [[_builder-builder]] | upstream | 0.24 |
