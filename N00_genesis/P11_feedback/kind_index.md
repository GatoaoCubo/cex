...
## Purpose
Master index of all 28 kinds in pillar P11. Reference for /mentor, nucleus builders, and the 8F pipeline.
...
| `curation_nudge` | Proactive in-session memory-persistence reminder (asks, never blocks) | N04 | `curation-nudge-builder` |
...
| `revision_loop_policy` | Max-N revision iterations before escalation (security > quality > impl) | N05 | `revision-loop-policy-builder` |
...
## CoC Hierarchy Note
These 27 kinds follow the convention-over-configuration hierarchy: each instance
...
| [[bld_collaboration_ai_rmf_profile]] | downstream | 0.29 |
| [[bld_collaboration_quality_gate]] | related | 0.28 |
| [[bld_collaboration_retriever]] | downstream | 0.26 |
| [[bld_collaboration_safety_hazard_taxonomy]] | downstream | 0.26 |
| [[_builder-builder]] | upstream | 0.25 |
