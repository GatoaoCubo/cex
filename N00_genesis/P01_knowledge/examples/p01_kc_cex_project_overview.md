...
tldr: "CEX: 300 kinds, 12 pillars, 8 nuclei (N00-N07), 8F pipeline, 301 builders, 150 tools — transforms vague user intent into validated production artifacts."
...
- **150 tools** — SDK runtime (`cex_sdk/`, 78 .py files, 4504 lines)
...
|----------|-------------|-------|
| [[ctx_cex_new_dev_guide]] | related | 0.56 |
| [[p01_ctx_cex_project]] | related | 0.53 |
| [[agent_card_n07]] | downstream | 0.46 |
| [[n03_readme_technical]] | downstream | 0.42 |
| [[spec_cex_system_map]] | related | 0.41 |
| [[p02_agent_admin_orchestrator]] | downstream | 0.39 |
| [[p03_sp_n03_creation_nucleus]] | downstream | 0.38 |
| [[agent_card_engineering_nucleus]] | downstream | 0.37 |
| [[p10_entity_cex_system]] | downstream | 0.36 |
| [[p03_sp_admin_orchestrator]] | downstream | 0.36 |
