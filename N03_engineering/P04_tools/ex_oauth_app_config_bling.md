...
| Artifact | Kind | Role |
|----------|------|------|
| `ex_api_client_bling.md` | api_client | Consumes the access token |
| `ex_integration_guide_bling.md` | integration_guide | Full setup walkthrough |
| `ex_oauth_app_config_meli.md` | oauth_app_config | Mercado Livre OAuth (similar pattern) |
