...
| Artifact | Kind | Role |
|----------|------|------|
| `ex_api_client_shopify.md` | api_client | Outbound calls to Shopify |
| `ex_integration_guide_shopify.md` | integration_guide | Full setup guide |
| `ex_workflow_multi_marketplace_sync.md` | workflow | Sync orchestration |
| `ex_webhook_manager.md` | webhook | Webhook CRUD management |
