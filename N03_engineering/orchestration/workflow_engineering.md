...
steps_count: 4  
execution: mixed  
satellites: [satellite_alpha, satellite_beta]  
timeout: 3600  
...
## Steps  
### Step 1: gather_requirements [satellite_alpha]  
- **Agent**: satellite_alpha  
...
### Step 2: design_solution [satellite_beta]  
- **Agent**: satellite_beta  
...
### Step 3: implement_design [satellite_alpha]  
- **Agent**: satellite_alpha  
...
### Step 4: validate_prototype [satellite_beta]  
- **Agent**: satellite_beta  
...
## Signals  
- **On step complete**: {sat}_complete signal emitted by respective satellites (see signal-builder)  
...
- Spawn Config Builder for satellite configuration references.