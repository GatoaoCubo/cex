...
## Golden Example
INPUT: "Create director for a brand launch mission coordinating research, content, and marketing"
OUTPUT:
```yaml
id: ex_director_brand_launch
kind: director
pillar: P08
title: "Brand Launch Director"
version: "1.0.0"
created: "2026-04-06"
updated: "2026-04-06"
...
domain: "brand_launch"
quality: null
tags: [director, brand, launch, orchestration, P08]
...
```
## Identity
Brand Launch Director coordinates a 4-builder mission for launching a new brand presence.
...
WHY THIS IS GOLDEN:
- quality: null (H05) | id ex_director_ pattern (H02) | kind: director (H04)
...
## Anti-Example
INPUT: "Create director that writes marketing copy and coordinates builders"
BAD OUTPUT:
```yaml
...
7. Director WRITES copy ("Buy our product") -> S10 FAIL (purity violation)
