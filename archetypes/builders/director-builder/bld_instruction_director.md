---
kind: instruction
id: bld_instruction_director
pillar: P03
llm_function: REASON
purpose: Step-by-step production process for director
pattern: 3-phase pipeline (research -> compose -> validate)
---

# Instructions: How to Produce a director
## Phase 1: RESEARCH
1. Identify the mission or goal this director coordinates — what outcome do the builders collectively produce?
...
9. Write Routing section: keywords and triggers that activate this director
10. Write Crew Role section: the coordination question this director answers, and explicit exclusions
11. Check body <= 2048 bytes
## Phase 3: VALIDATE
1. Check QUALITY_GATES.md manually
2. HARD gate: id matches `ex_director_` pattern
3. HARD gate: kind == director
4. HARD gate: quality == null
5. HARD gate: builders list has >= 2 entries (a director with 1 builder is pointless)
...
9. Cross-check: does the director contain ANY task execution logic? If yes, remove it — directors dispatch, not execute
