---
kind: examples
id: bld_examples_event_schema
pillar: P07
llm_function: GOVERN
purpose: Golden and anti-examples of event_schema artifacts
pattern: few-shot learning -- LLM reads these before producing
quality: null
title: "Examples Event Schema"
version: "1.0.0"
author: n03_builder
tags: [event_schema, builder, examples]
tldr: "Golden and anti-examples for event_schema: CloudEvents envelope, payload JSON Schema, versioning, consumer table."
