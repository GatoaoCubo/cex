...
tags: [kind-builder, event-schema, P06, cloudevents, asyncapi, event-driven]
keywords: [event schema, CloudEvents, AsyncAPI, event payload, versioning, routing, domain event]
triggers: ["create event schema", "define event payload", "cloudevents schema", "asyncapi schema", "domain event definition"]
capabilities: >
  L1: Specialist in building event_schema artifacts -- CloudEvents/AsyncAPI payload schemas for event-driven systems. L2: Define event type, payload structure, versioning, and routing metadata following CloudEvents 1.0 / AsyncAPI 3.0 standards. L3: When user needs to formally define event payload structure, versioning, and routing metadata for async messaging.
quality: null
title: "Manifest Event Schema"
tldr: "Builds event_schema artifacts -- CloudEvents/AsyncAPI payload schemas with structure, versioning, and routing metadata."
density_score: 0.90
---
