...
tldr: "Domain knowledge for prompt_compiler: intent resolution, DSPy compilation, bilingual NLU, 8F integration."
...
| Bilingual requirement | >= 80% of EN patterns must have PT-BR equivalents |
