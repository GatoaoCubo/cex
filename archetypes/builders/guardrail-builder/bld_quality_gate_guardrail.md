...
| expiry | 6 hours maximum; guardrail must re-engage automatically or be replaced with compliant artifact |
| never bypass | H01 (corrupt YAML), H05 (self-scored quality invalid), H07 (severity drives escalation routing — wrong value causes silent misrouting), H08 (enforcement mode drives system response — absent causes no-op) |
