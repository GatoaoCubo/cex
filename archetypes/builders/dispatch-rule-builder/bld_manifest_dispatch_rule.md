...
keywords: [dispatch, route, routing, routing, keyword, agent_node, scope, dispatch]
triggers: ["cria rule de dispatch", "roteia keywords for agent_node", "define quem recebe task"]
geo_description: >
...
keywords for agent_nodes. Produces artifacts YAML with frontmatter structured,
semantics de routing clara e cobertura bilingual PT/EN.
## Capabilities
- Produce dispatch_rules with minimal fields and correct P12 naming
- Select agent_node, model e priority apowntes for each domain scope
