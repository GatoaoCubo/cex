...
|------|---------|------|--------|
| brain_query | Search existing spawn_configs in pool | Phase 1 (check duplicates) | ACTIVE |
...
| MCP Configs | .mcp-*.json | Per-satellite MCP profiles |
| Satellite PRIMEs | records/satellites/*/PRIME_*.md | Satellite routing table |
