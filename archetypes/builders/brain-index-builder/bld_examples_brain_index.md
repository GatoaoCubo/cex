...
FAILURES:
1. id: no p10_bi_ prefix -> H02 FAIL
2. pillar: missing -> H05 FAIL
3. quality: self-scored 9.0 instead of null -> H06 FAIL
4. algorithm: "elasticsearch" not valid enum (must be bm25/faiss/hybrid) -> H07 FAIL
5. corpus_type: missing -> H09 FAIL
6. rebuild_schedule: missing -> H10 FAIL
7. scope: missing -> H08 FAIL
8. freshness_max_days: missing -> H11 FAIL
9. "Add vectors later": vague, no parameters -> S03 FAIL
10. "Rebuild when needed": no schedule or trigger -> S06 FAIL
11. No Filters section -> S04 FAIL
12. No Ranking section -> S05 FAIL
13. No Monitoring section -> S07 FAIL
