...
**In scope**: input/output pair crafting, difficulty calibration (easy/medium/hard), edge case coverage, format exemplification, few_shot_example frontmatter authoring.

**Out of scope**: quality scoring (golden-test-builder), pass/fail evaluation (quality-gate-builder), unit test assertions (unit-eval-builder), prompt template authoring (prompt-template-builder).
