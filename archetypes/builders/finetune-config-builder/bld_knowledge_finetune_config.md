...
- HuggingFace TRL: huggingface.co/docs/trl (SFTTrainer, DPOTrainer)
- Axolotl: github.com/axolotl-ai-cloud/axolotl (YAML config format)
- Unsloth: github.com/unslothai/unsloth (QLoRA memory optimizations)

## Related Artifacts

| Artifact | Relationship | Score |
|----------|-------------|-------|
| [[p01_kc_finetune_config]] | sibling | 0.50 |
| [[p03_sp_finetune_config_builder]] | downstream | 0.49 |
| [[bld_instruction_finetune_config]] | downstream | 0.45 |
| [[finetune-config-builder]] | downstream | 0.44 |
| [[bld_examples_finetune_config]] | downstream | 0.44 |
| [[bld_config_finetune_config]] | downstream | 0.39 |
| [[bld_output_template_finetune_config]] | downstream | 0.38 |
| [[p11_qg_finetune_config]] | downstream | 0.38 |
| [[bld_architecture_finetune_config]] | downstream | 0.36 |
| [[spec_vllm_lora_hotswap]] | downstream | 0.34 |
