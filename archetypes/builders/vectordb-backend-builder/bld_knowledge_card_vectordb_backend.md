---
kind: knowledge_card
id: bld_knowledge_card_vectordb_backend
pillar: P01
llm_function: INJECT
purpose: Domain knowledge for vectordb_backend production — atomic searchable facts
sources: vectordb-backend-builder SCHEMA + MANIFEST, backend docs, HNSW paper
---

# Domain Knowledge: vectordb_backend
## Executive Summary
...
| Kind | `vectordb_backend` (exact literal) |
