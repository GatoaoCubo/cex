---
kind: memory
id: bld_memory_vectordb_backend
pillar: P10
llm_function: INJECT
purpose: Accumulated production experience for vectordb_backend artifact generation
memory_scope: project
observation_types: [user, feedback, project, reference]
---
# Memory: vectordb-backend-builder
## Summary
