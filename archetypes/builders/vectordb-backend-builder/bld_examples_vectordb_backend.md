---
kind: examples
id: bld_examples_vectordb_backend
pillar: P07
llm_function: GOVERN
purpose: Golden and anti-examples of vectordb_backend artifacts
pattern: few-shot learning — LLM reads these before producing
---

# Examples: vectordb-backend-builder
## Golden Example
...
quality: null
tags: [vectordb-backend, chroma, hnsw, local]
...
## Boundary
vectordb_backend IS: storage and indexing config for Chroma (HNSW index, 1536 dimensions, cosine).
vectordb_backend IS NOT: embedder_provider, model_provider, retriever, chunker.
## Backend Matrix
...
2. kind: "vectordb" not "vectordb_backend" — H04 FAIL
