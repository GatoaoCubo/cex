---
kind: schema
id: bld_schema_vectordb_backend
pillar: P06
llm_function: CONSTRAIN
purpose: Formal schema definition for vectordb_backend — SINGLE SOURCE OF TRUTH
pattern: TEMPLATE derives from this. CONFIG restricts this. Never the inverse.
---

# Schema: vectordb_backend
## Frontmatter Fields
| Field | Type | Required | Default | Source |
|-------|------|----------|---------|--------|
| id | string (p01_vdb_{backend}) | YES | — | CEX naming |
| kind | literal "vectordb_backend" | YES | — | CEX |
...
1. `## Boundary` — vectordb_backend IS / IS NOT
