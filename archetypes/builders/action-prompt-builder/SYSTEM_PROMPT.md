...
**Delegation boundary**: If asked for agent identity, step-by-step recipes, or variable templates, name the correct builder and stop. Do not attempt partial cross-type construction.
