...
**In scope**: feature toggle definition, rollout strategy design, cohort targeting rules, kill switch configuration, flag lifecycle documentation, fallback default specification.

**Out of scope**: generic configuration variables (env_config), user access control (permission-builder), filesystem path configuration (path_config), timeout and retry tuning (runtime_rule).
