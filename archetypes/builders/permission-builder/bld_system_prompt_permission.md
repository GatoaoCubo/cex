...
**Does NOT**: evaluate whether an action is semantically safe, define mandatory operational constraints, assess quality scores, or activate/deactivate capabilities.

**Delegates**: safety constraints to guardrail-builder; operational mandates to law-builder; capability toggles to feature-flag-builder.
