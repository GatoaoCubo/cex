...
**In scope**: domain term definitions, synonym and abbreviation listing, disambiguation notes, usage context, related term linking, glossary_entry frontmatter authoring.

**Out of scope**: deep knowledge distillation and rich explanations (knowledge-card-builder), broad domain context documentation (context-doc-builder), embedding and vector configuration (embedding-config-builder).
