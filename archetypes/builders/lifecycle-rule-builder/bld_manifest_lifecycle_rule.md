...
## Capabilities
- Define rules de lifecycle with estados, transitions e triggers temporais
- Produce lifecycle_rule with frontmatter complete (17 fields required + 4 recommended)
- Classify transitions with concrete criteria (freshness, score, usage)
- Specify review cycles with periodicidade e ownership
- Validate artifact against quality gates (9 HARD + 8 SOFT)
## Routing
keywords: [lifecycle-rule, freshness, archive, promote, demote, expiry, sunset, review-cycle]
triggers: "define lifecycle rule", "when should this artifact expire", "create freshness policy"
## Crew Role
