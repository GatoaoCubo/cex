...
2. MUST include universal fields in generated ISOs (keywords, triggers, geo_description in manifest; memory_scope, observation_types in memory; effort, max_turns, hooks, permission_scope in config; Tool Permissions in tools)
