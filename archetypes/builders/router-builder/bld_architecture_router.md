...
## Dependency Graph
```
incoming_task   --routed_by-->   router  --dispatches_to-->  agent_node/agent
...
| router | agent_node/agent (P02) | produces | task dispatched to matched destination |
...
| Output | agent_node/agent, routing_decision | Dispatch task and signal the routing result |
