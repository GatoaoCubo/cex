...
5. Missing required fields: version, created, updated, author, description, user_invocable, phases, when_to_use, when_not_to_use, examples — H06 FAIL
6. No phases list in frontmatter — H08 FAIL
7. Body missing ## Purpose section — H07 FAIL
8. Body missing ## Workflow Phases section — H07 FAIL
9. "You are a deploy specialist" — identity language in skill body, belongs in system_prompt — S05 FAIL
10. No ## Anti-Patterns section — S06 FAIL
11. No ## Metrics section — S07 FAIL
12. trigger: "deploy" with user_invocable absent — S03 ambiguous FAIL
