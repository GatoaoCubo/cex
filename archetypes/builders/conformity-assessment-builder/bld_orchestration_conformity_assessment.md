...
| User / provider | Technical documentation reference | File path or URL | MANDATORY |
| User / provider | Declaration date | ISO date | MANDATORY |
...
5. Commit: git add P11_govern/p11_ca_[system_slug].md && git commit -m "[N03] conformity_assessment: [system_name]"
...
| Article-43 route determination | Internal check vs. notified body based on category |
...
Signal format:
```
{nucleus: n03, status: complete, score: 9.2,
 artifact: P11_govern/p11_ca_{system}.md,
...
Deliver: compiled .md artifact path + link to technical documentation reference.
Do NOT deliver: legal opinions, compliance declarations, or liability assessments.

## Related Artifacts

| Artifact | Relationship | Score |
|----------|-------------|-------|
| [[bld_instruction_conformity_assessment]] | upstream | 0.48 |
| [[bld_output_template_conformity_assessment]] | upstream | 0.43 |
| [[bld_system_prompt_conformity_assessment]] | upstream | 0.43 |
...
| [[bld_schema_conformity_assessment]] | upstream | 0.38 |
| [[bld_examples_conformity_assessment]] | upstream | 0.34 |
| [[bld_memory_conformity_assessment]] | upstream | 0.33 |
| [[bld_config_conformity_assessment]] | upstream | 0.32 |
