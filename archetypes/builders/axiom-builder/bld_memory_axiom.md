...
High. The negation test is a deterministic procedure. Results may vary if the scenario generator is not domain-knowledgeable, but the test structure itself is stable.

## References

- P10 axiom schema (20 frontmatter fields)
- Anti-pattern: authority-based-axiom-declaration
- Related: law-builder, guardrail-builder
