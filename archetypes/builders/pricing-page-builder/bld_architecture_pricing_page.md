...
| bld_instruction      | Specifies pricing logic and rules         | P05    | Active |
| bld_system_prompt    | Guides AI in generating pricing content   | P05    | Active |
| bld_schema           | Enforces data format validation           | P05    | Active |
| bld_quality_gate     | Ensures content meets quality standards   | P05    | Active |
| bld_output_template  | Formats final pricing page output         | P05    | Active |
| bld_examples         | Provides sample pricing scenarios         | P05    | Active |
| bld_knowledge_card   | Stores pricing-related knowledge assets   | P05    | Active |
| bld_architecture     | Defines builder system architecture       | P05    | Active |
| bld_collaboration    | Manages team workflows and feedback       | P05    | Active |
| bld_config           | Centralizes pricing builder settings      | P05    | Active |
| bld_memory           | Tracks pricing page session data          | P05    | Active |
| bld_tools            | Integrates external pricing utilities     | P05    | Active |
...
| bld_tools        | analytics_tool   | External API |
