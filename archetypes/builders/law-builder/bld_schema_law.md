...
updated: "2026-03-26"
author: EDISON
tags: [schema, law-builder, source-of-truth, P08]
---
...
| kind | literal "law" | YES | — | H04 | Exact string "law". Never "rule", "mandate", "policy". |
...
| tags | list[string], len >= 3 | YES | — | H07 | Must include "law" and pillar tag. |
