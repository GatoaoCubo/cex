...
This plugin extends the system. Use it when you need more features.

FAILURES:
1. id: no `p04_plug_` prefix -> H02 FAIL
2. kind: "extension" not "plugin" -> H04 FAIL
3. pillar: "P02" not "P04" -> H06 FAIL
4. quality: 9.0 (not null) -> H05 FAIL
5. lifecycle: [] (must include on_load + on_unload) -> H08 FAIL
6. api_surface_count: 0 (must have at least 1 method) -> H07 FAIL
7. Missing fields: version, created, updated, author, interface, enabled, dependencies, domain -> H06 FAIL
8. tags: only 1 item -> S02 FAIL
9. tldr: filler ("designed to extend...various capabilities") -> S12 FAIL
10. No ## Interface Contract section -> S03 FAIL
11. No ## API Surface table -> S04 FAIL
12. No ## Configuration section -> S05 FAIL
13. No ## Lifecycle Hooks section -> S06 FAIL
14. Prose body instead of structured contract definition -> S04 FAIL
