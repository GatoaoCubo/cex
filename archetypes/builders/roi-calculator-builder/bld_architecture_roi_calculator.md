...
| bld_instruction     | Task execution guidelines     | P11    | Active  |
| bld_system_prompt   | LLM interaction framework     | P11    | Active  |
...
| bld_examples        | Sample input/output           | P11    | Active  |
| bld_knowledge_card  | Domain-specific knowledge     | P11    | Active  |
| bld_architecture    | Builder system design         | P11    | Active  |
| bld_collaboration   | Multi-builder coordination    | P11    | Active  |
| bld_config          | Runtime parameter management  | P11    | Active  |
| bld_memory          | State retention mechanism    | P11    | Active  |
