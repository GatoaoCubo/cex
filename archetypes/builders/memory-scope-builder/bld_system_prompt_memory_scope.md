...
memory_scope IS NOT session_state (P10, runtime state), brain_index (P10, search index), learning_record (P10, pattern storage).
...
7. NEVER conflate memory_scope with adjacent types — session_state (P10, runtime state), brain_index (P10, search index), learning_record (P10, pattern storage).
