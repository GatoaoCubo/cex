...
version: "1.0.0"
author: wave7_n05
tags: [agent_name_service_record, builder, collaboration]
...
| 8F Stage | This builder's action |
|----------|----------------------|
| F2 BECOME | Load all 13 ISOs from this directory |
| F3 INJECT | Read agent_card + secret_config + transport_config |
| F4 REASON | Phase 1 RESEARCH checklist from bld_instruction |
| F6 PRODUCE | Fill bld_output_template with resolved data |
| F7 GOVERN | Run bld_quality_gate H01-H08 + 5D scoring |
| F8 COLLABORATE | Compile, score, signal, notify lifecycle_rule |

## Related Artifacts

| Artifact | Relationship | Score |
|----------|-------------|-------|
| [[bld_system_prompt_agent_name_service_record]] | upstream | 0.58 |
| [[bld_architecture_agent_name_service_record]] | upstream | 0.53 |
| [[bld_manifest_agent_name_service_record]] | upstream | 0.52 |
| [[bld_knowledge_card_agent_name_service_record]] | upstream | 0.51 |
| [[bld_instruction_agent_name_service_record]] | upstream | 0.49 |
| [[bld_output_template_agent_name_service_record]] | upstream | 0.47 |
| [[bld_memory_agent_name_service_record]] | upstream | 0.46 |
| [[bld_tools_agent_name_service_record]] | upstream | 0.45 |
| [[bld_examples_agent_name_service_record]] | upstream | 0.42 |
| [[bld_schema_agent_name_service_record]] | upstream | 0.40 |
