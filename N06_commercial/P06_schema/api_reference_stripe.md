...
- `input_schema_checkout.md` -- validates order before Stripe session creation
- `enum_def_pricing_tiers.md` -- maps tier names to Stripe Price IDs
- `churn_prevention_playbook_n06.md` -- triggered by `invoice.payment_failed`
- `renewal_workflow_n06.md` -- triggered by `invoice.upcoming`
