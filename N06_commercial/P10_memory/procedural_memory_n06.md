...
- `sales_playbook_n06.md` -- PROC-002 demo execution
- `churn_prevention_playbook_n06.md` -- PROC-005 payment failure
- `renewal_workflow_n06.md` -- PROC-004 renewal management detail
- `entity_memory_customer.md` -- all procedures update customer entity
