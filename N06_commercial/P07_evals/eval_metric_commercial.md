...
- `cohort_analysis_n06.md` -- segment-level metric analysis
- `self_improvement_loop_n06.md` -- metrics feed into improvement hypothesis generation
- `churn_prevention_playbook_n06.md` -- alert thresholds trigger playbook execution
- `subscription_tier_n06.md` -- tier-level metric targets
