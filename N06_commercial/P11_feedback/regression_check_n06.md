...
- `self_improvement_loop_n06.md` -- failed hypotheses get logged here
- `learning_record_n06.md` -- positive patterns (what to do)
- `reward_signal_n06.md` -- validated winning patterns
