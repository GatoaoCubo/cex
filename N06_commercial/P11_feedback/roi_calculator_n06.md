...
- `subscription_tier_n06.md` -- tier prices used in calculation
- `discovery_questions_n06.md` -- collects input variables during sales call
- `sales_playbook_n06.md` -- ROI calculator is slide 3 in demo sequence
