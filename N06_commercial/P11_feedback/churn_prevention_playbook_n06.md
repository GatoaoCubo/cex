...
- `subscription_tier_n06.md` -- churn risk signals per tier
- `renewal_workflow_n06.md` -- pre-renewal churn prevention
- `entity_memory_customer.md` -- health_score and churn_risk tracked here
- `eval_metric_commercial.md` -- churn rate KPI tracking
