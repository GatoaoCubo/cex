...
- `churn_prevention_playbook_n06.md` -- save plays by signal type
- `entity_memory_customer.md` -- health score and churn risk source
- `eval_metric_commercial.md` -- renewal KPIs tracked here
- `procedural_memory_n06.md` -- PROC-004 renewal management
