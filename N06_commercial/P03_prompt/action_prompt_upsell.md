...
- `expansion_play_n06.md` -- trigger conditions that fire these prompts
- `subscription_tier_n06.md` -- tier features referenced in templates
- `roi_calculator_n06.md` -- calculates the $ savings figures in Template 5
