...
- `roi_calculator_n06.md` -- discovery answers feed directly into ROI inputs
- `sales_playbook_n06.md` -- discovery is Stage 1 of full sales conversation
- `entity_memory_customer.md` -- discovery answers stored in customer entity
