...
- donts: [{'avoid': 'Usar jargao bancario', 'instead': 'correntista → cliente, operacao de credito → emprestimo'}, {'avoid': 'Ser excessivamente formal', 'instead': 'Prezado Senhor → Ola, João'}, {'avoid': 'Culpar o cliente por erros', 'instead': 'Voce errou a senha → A senha digitada nao confere'}, {'avoid': 'Usar asteriscos e letrinhas', 'instead': 'Deixar condicoes claras no texto principal'}, {'avoid': 'Prometer e nao cumprir', 'instead': 'So comunicar o que podemos entregar'}, {'avoid': 'Ser frio em momentos dificeis', 'instead': 'Sabemos que isso e frustrante...'}]
- seed_words: [{'word': 'roxinho', 'meaning': 'O cartao Nubank (apelido carinhoso)', 'usage': 'Meu roxinho chegou! / Paga no roxinho?'}, {'word': 'descomplicar', 'meaning': 'Tornar simples o que era complexo', 'usage': 'Descomplicamos o mundo financeiro'}, {'word': 'digital first', 'meaning': 'Prioridade para experiencia digital', 'usage': 'Nascemos digital first'}, {'word': 'Nu', 'meaning': 'Prefixo para produtos e servicos', 'usage': 'NuConta, NuInvest, NuCripto'}, {'word': 'humanizado', 'meaning': 'Atendimento com empatia real', 'usage': 'Atendimento humanizado, nao robotico'}]
