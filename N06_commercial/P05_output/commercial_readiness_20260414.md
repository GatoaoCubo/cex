...
version: 2.0.0
quality: 8.9
tags: [commercial, tiers, roadmap, wave4, gtm, pricing]
created: 2026-04-14
nucleus: n06
...
|--------|-----------|-----------|-------|
| Total kinds | 184 | 202 | +18 |
| Total builders | 189 | 207 | +18 |
| Total ISOs | 2,432 | 2,666 | +234 |
| ISO validator pass rate | ~95% | 100% (2666/2666) | +5pp |
| Wave 4 mean quality | -- | 9.0-9.2 | established |
| PRO-tier kinds added | 0 | 10 | +10 |
| ENTERPRISE-tier kinds added | 0 | 8 | +8 |
| Audit cycles complete | 3 | 5 | +2 |
| GTM readiness | 36% | 46% | +10pp |

Wave 4 additions confirmed in kinds_meta.json:

**PRO (10)**: ab_test_config, course_module, subscription_tier, user_journey,
onboarding_flow, pricing_page, cohort_analysis, referral_program, usage_quota,
customer_segment

**ENTERPRISE (8)**: compliance_checklist, usage_report, rbac_policy, audit_log,
enterprise_sla, data_residency, sso_config, white_label_config

## Updated Pricing Tier Map

### FREE (attract) -- 18 kinds

Target: developers discovering CEX, evaluators, open-source contributors.
Conversion hook: FREE artifacts immediately hit limits that PRO kinds remove.

| Kind | Pillar | Why Free | Conversion Hook |
|------|--------|----------|-----------------|
| knowledge_card | P01 | Universal building block, zero learning curve | Embedding_config + agentic_rag hit wall at scale |
| agent | P02 | Core primitive -- every AI product needs one | agent_package + agent_profile are PRO |
| workflow | P12 | Visual logic entry point | workflow_node + dag + dispatch_rule are PRO |
| prompt_template | P03 | Lowest-friction entry into CEX | prompt_optimizer + prompt_compiler are PRO |
...
### PRO (convert) -- 49 kinds (was 39, now +10 Wave 4)
...
### ENTERPRISE (retain + expand) -- 35 kinds (was 27, now +8 Wave 4)

Target: regulated industries (fintech, health, legal), large teams (50+ seats), MLOps orgs.
Price point: $2,500-15,000/mo. ACV $30K-$180K. Annual commit required.
...
| Enterprise features | 27 ENTERPRISE kinds (38%) | 35 ENTERPRISE kinds; rbac+sso+audit_log+sla+data_residency fully covered | 72% | +34pp |
| Demo assets | No demo, no sandbox, no playground | Unchanged -- requires N05 deployment scope | 10% | 0pp |
| Sales enablement | No pitch deck, no case studies, no ROI calc | Unchanged -- Wave 5 must close this | 5% | 0pp |
| Open source story | Repo exists, no README-driven docs | Unchanged -- no CONTRIBUTING.md, no gallery | 25% | 0pp |

**Overall GTM readiness after Wave 4: 46%** (unweighted avg: 46% vs 36% pre-Wave 4)

### Key wins from Wave 4

1. **Enterprise security stack complete**: rbac_policy + sso_config + audit_log + data_residency + compliance_checklist now exist as builders. Any CISO/compliance buyer can get from "evaluation" to "purchase order" using CEX alone.
2. **Monetization loop closed**: CEX now has pricing_page + subscription_tier + content_monetization. The system can generate its own pricing artifacts -- a credibility signal for commercial buyers.
3. **PLG tooling shipped**: onboarding_flow + user_journey + cohort_analysis + referral_program address the full PLG flywheel (activate → retain → expand → refer).
4. **EdTech vertical unlocked**: course_module opens a $8B TAM adjacent to the core AI infrastructure market.

### Remaining GTM blockers (Wave 4 did NOT close)

- Developer docs: still 40% -- no public quickstart, no API reference, no SDK examples
- Demo/playground: still 10% -- zero interactive evaluation path
- Sales enablement: still 5% -- no pitch deck, no ROI calculator, no battle cards
- Open source: still 25% -- no CONTRIBUTING.md, no example gallery

## Wave 5 Recommendation: Developer + Sales Enablement (18 kinds)

**Wave 5 thesis**: Waves 1-4 built the product. Wave 5 makes the product SELLABLE.
GTM ceiling at 46% is artificial -- the system is technically ready, commercially invisible.

### Top 18 kinds for Wave 5

| # | Kind | Domain | Tier | GTM Impact | Build Effort |
|---|------|--------|------|-----------|-------------|
| 1 | quickstart_guide | Developer docs | FREE | Highest-traffic page for any dev tool. Converts evaluators. | LOW -- P03 doc pattern |
| 2 | api_reference | Developer docs | FREE | Required for API-first GTM. Removes 80% of support questions. | LOW -- P06 schema + P05 output |
| 3 | pitch_deck | Sales | PRO | Enables sales motion day 1. N06 + N02 co-produce. | MEDIUM -- P05 output pattern |
| 4 | roi_calculator | Sales | ENTERPRISE | CFO/economic buyer closer. Converts ENTERPRISE pilots to contracts. | MEDIUM -- P07 eval + P11 monetization |
| 5 | case_study | Social proof | PRO | Social proof that feeds all channels: website, deck, email, ads. | LOW -- P05 output + P01 KC |
| 6 | playground_config | Demo | PRO | PLG top of funnel. Interactive eval path cuts time-to-value 80%. | MEDIUM -- P09 config + P04 tool |
| 7 | sdk_example | Developer docs | FREE | Shows real usage patterns. Developer trust signal. | LOW -- P03 prompt + P04 tool |
| 8 | competitive_matrix | Sales | ENTERPRISE | CISO/CTO decision artifact. Sales battle card. | LOW -- P01 KC pattern |
| 9 | interactive_demo | Demo | PRO | Highest PLG conversion for complex products. Replaces video tour. | HIGH -- P05 output + P04 tools |
| 10 | integration_guide | Developer docs | PRO | Reduces implementation friction for paid tier onboarding. | LOW -- P03 doc + P04 tool |
| 11 | sales_playbook | Sales | ENTERPRISE | Scales sales team. N06 self-referential (CEX sells itself with its own artifacts). | MEDIUM -- P03 + P11 |
| 12 | changelog | Developer docs | FREE | Developer trust + retention signal. Reduces churn 10-15%. | LOW -- P01 KC + P05 output |
| 13 | sandbox_spec | Demo | ENTERPRISE | Safe eval environment for enterprise pilots. Procurement gate. | MEDIUM -- P09 config |
| 14 | discovery_questions | Sales | ENTERPRISE | Improves sales qualification rate. Shortens deal cycle. | LOW -- P01 KC |
| 15 | healthcare_vertical | Industry | ENTERPRISE | Regulated industry. HIPAA gate. ACV $50K-$200K avg. | MEDIUM -- vertical KC |
| 16 | fintech_vertical | Industry | ENTERPRISE | SOC2 + PCI-DSS gate. ACV $50K-$150K avg. High LTV. | MEDIUM -- vertical KC |
| 17 | legal_vertical | Industry | ENTERPRISE | Highest billing rate sector. ACV $100K-$500K avg. | MEDIUM -- vertical KC |
| 18 | product_tour | Demo | PRO | Walkthrough guide artifact. Replaces onboarding call. Scales to thousands. | LOW -- P03 + P05 |

**Wave 5 GTM projection** (if built): Developer docs (+18pp), demo (+20pp), sales (+25pp) = estimated 109% total (capped at 95% with residual gaps).
Realistic Wave 5 GTM target: **72-75%**

### Priority order

**Ship first (1-4 weeks)**: quickstart_guide, api_reference, sdk_example, changelog, competitive_matrix, discovery_questions (all LOW effort, immediate revenue impact)

**Ship next (4-8 weeks)**: pitch_deck, roi_calculator, case_study, playground_config, integration_guide, sales_playbook, sandbox_spec (MEDIUM effort, closes enterprise deals)

**Ship last (8-16 weeks)**: interactive_demo, healthcare_vertical, fintech_vertical, legal_vertical, product_tour (HIGH effort or vertical-specific -- requires N01 deep research)

## Revenue Projection Update (post Wave 4)

### Addressable buyer personas (expanded from 2 to 5)

| Persona | Entry point | Upgrade trigger | ACV range |
|---------|------------|----------------|-----------|
| AI developer | agent + knowledge_card (FREE) | agentic_rag + prompt_optimizer (PRO) | $49-149/mo |
| AI practitioner / team lead | voice_pipeline + eval_framework (PRO) | guardrail + red_team_eval (ENTERPRISE) | $299-799/mo team |
| Growth / PLG lead | ab_test_config + onboarding_flow (PRO, new Wave 4) | cohort_analysis + referral_program (PRO) | $149/mo |
| Compliance / security officer | compliance_checklist (ENTERPRISE, new Wave 4) | rbac_policy + sso_config + audit_log + data_residency (ENTERPRISE) | $5K-15K/mo |
| Enterprise architect / CTO | white_label_config + enterprise_sla (ENTERPRISE, new Wave 4) | Full platform license + training data | $10K-50K/mo |

### TAM expansion from Wave 4

| Dimension | Pre-Wave 4 | Post-Wave 4 | Expansion |
|-----------|-----------|-----------|-----------|
...
|-------|-----|-------------|-------|
| Tier-based (FREE/PRO/ENTERPRISE) | HIGH | $0/$99/$5K | Aligns with kind complexity. Wave 4 strengthens tier differentiation. |
| API calls (programmatic access) | HIGH | $0.01-0.10/call | Complements tier. Usage_quota kind makes this self-configurable. |
...
## Anchor Kinds -- Updated Top 10

| # | Kind | Tier | Why It Anchors | New since Wave 4? |
|---|------|------|----------------|-------------------|
| 1 | knowledge_card | FREE | Universal entry point -- every user creates one first | No |
| 2 | agent | FREE->PRO | Core primitive -- agent_package upsell is natural | No |
| 3 | voice_pipeline | PRO | High perceived value -- demo-able in 60s | No |
| 4 | guardrail | ENTERPRISE | Compliance trigger -- legal/security teams mandate this | No |
| 5 | rbac_policy | ENTERPRISE | Multi-tenant gate -- no ENTERPRISE deal closes without RBAC | YES (Wave 4) |
| 6 | agentic_rag | PRO | RAG upgrade story -- outperforms naive RAG measurably | No |
| 7 | pricing_page | PRO | CEX builds its own pricing -- demo + artifact in one | YES (Wave 4) |
| 8 | onboarding_flow | PRO | PLG activation -- "first value" moment is measurable | YES (Wave 4) |
| 9 | self_improvement_loop | ENTERPRISE | Competitive moat -- "AI that improves itself" | No |
| 10 | white_label_config | ENTERPRISE | OEM/reseller enabler -- multiplies ACV through partners | YES (Wave 4) |

4 of 10 anchor kinds are Wave 4 additions. Wave 4 fundamentally changed the commercial center of gravity.

## Critical Path to 80% GTM Readiness

| Step | Action | Owner | Estimated GTM lift |
|------|--------|-------|-------------------|
| 1 | Build Wave 5 (18 kinds: docs + demo + sales) | N03 | +26-29pp |
| 2 | Generate developer portal from existing KCs | N04 + N02 | +10pp |
| 3 | Build landing_page artifact for CEX itself | N02 | +5pp |
| 4 | Build pricing page using pricing_page + subscription_tier | N06 | already possible (builders exist) |
| 5 | Create 3 demo workflows FREE->PRO->ENTERPRISE | N02 + N05 | +10pp |
| 6 | Write 2 case studies using course_module + onboarding_flow | N02 | +5pp |

**Projected GTM at 80%+ completion**: Wave 5 + docs + demos = ~75% (Wave 6 closes final 5-25%).

## Related Artifacts

| Artifact | Relationship | Score |
|----------|-------------|-------|
| [[commercial_readiness_20260413]] | sibling | 0.68 |
| [[commercial_readiness_20260414b]] | sibling | 0.47 |
| [[n06_intent_resolution_depth_spec]] | sibling | 0.34 |
| [[spec_mission_100pct_coverage]] | upstream | 0.30 |
| [[commercial_readiness_20260414c]] | sibling | 0.27 |
| [[n06_report_intent_resolution_moat]] | sibling | 0.26 |
| [[kc_llm_vocabulary_atlas]] | upstream | 0.23 |
| [[p06_schema_taxonomy]] | upstream | 0.23 |
| [[bld_instruction_subscription_tier]] | upstream | 0.23 |
| [[p01_kc_supabase_pricing]] | upstream | 0.22 |
