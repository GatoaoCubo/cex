...
- `kno_retriever_config_n05.md` should retrieve chunks that look like the evidence in this example
- `mem_learning_record_n05.md` captures that evidence-first verdicts reduce false approvals
- `mem_memory_summary_n05.md` should preserve the final verdict and blockers when sessions are compressed
