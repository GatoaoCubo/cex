...
Funcao LLM eh o que o modelo FAZ com um artefato, nao o que o artefato EH. As 8 funcoes (BECOME, INJECT, REASON, CALL, PRODUCE, CONSTRAIN, GOVERN, COLLABORATE) formam o pipeline real de execucao de qualquer sistema LLM. Um prompt simples executa 1-2 funcoes. Um agente executa 4-5. Um satellite com lifecycle completo executa todas as 8. A diferenca eh de completude, nao de natureza.
