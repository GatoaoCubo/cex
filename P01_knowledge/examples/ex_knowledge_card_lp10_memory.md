...
## Application
No CODEXA, P10 manifesta como mental_model.yaml por satelite, Brain MCP (BM25+FAISS), learning memory (.claude/rules/codexa-learning.md), e MEMORY.md. O CEX formaliza cada tipo com schema validavel.

## References
- P10_memory/_schema.yaml (fonte de verdade)
- records/satellites/{sat}/mental_model.yaml (instancias reais)
