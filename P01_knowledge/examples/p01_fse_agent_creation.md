...
files:
  ...
  - iso_vectorstore/ISO_LILY_092_OUTPUT_TEMPLATE.md
  - iso_vectorstore/ISO_LILY_093_EXAMPLES.md
  - iso_vectorstore/ISO_LILY_094_QUICK_START.md
  - iso_vectorstore/ISO_LILY_095_PRIME.md
quality: 8.8
pool_eligible: true
```

Source: `records/agents/codexa/iso_vectorstore/ISO_EDISON_060_EXAMPLES.md`
