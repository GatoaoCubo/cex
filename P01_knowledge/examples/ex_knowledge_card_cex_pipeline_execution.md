...
when_to_use: "Entender a sequencia completa de execucao de um agente ou satellite LLM do input ao output"
...
long_tails:
  ...
  - "Como funciona o boot sequence de um satellite CODEXA"
axioms:
...
linked_artifacts:
  ...
  related: [p01_kc_cex_satellite_concept, p01_kc_cex_cortex_enterprise]
density_score: null
...
Todo sistema LLM executa as mesmas 8 funcoes na mesma ordem logica. Um prompt simples executa 1-2 (BECOME implicito + PRODUCE). Um agente executa 4-5. Um satellite com lifecycle completo executa todas as 8. A diferenca entre prompt e satellite nao eh de natureza — eh de completude. A boot sequence de um Cortex Enterprise eh ela mesma uma instanciacao dessas 8 funcoes.
...
| 5 | PRODUCE | Gera output: codigo, KCs, copy, deploy | Executar agent teams por satellite |
...
| Satellite completo | Executa todas as 8 funcoes em sequencia |
...
# Satellite: all 8 functions, full lifecycle
```
