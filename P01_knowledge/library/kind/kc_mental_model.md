...
| Multi-tool generalist | Orchestrator or gateway agent | `domain: orchestration, tools: [all_satellites]` |
...
## Decision Tree
- IF agent is core satellite THEN mental_model required (boot dependency)
