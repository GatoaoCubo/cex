...
|----------|-------------|-------|
| [[p01_kc_secret_config]] | related | 0.59 |
| [[p09_secret_config]] | sibling | 0.49 |
| [[bld_collaboration_secret_config]] | downstream | 0.46 |
| [[bld_knowledge_card_secret_config]] | upstream | 0.35 |
| [[secret-config-builder]] | related | 0.33 |
| [[bld_config_secret_config]] | related | 0.32 |
| [[bld_instruction_secret_config]] | upstream | 0.32 |
| [[p09_secret_openai_key]] | sibling | 0.31 |
| [[bld_tools_env_config]] | upstream | 0.31 |
