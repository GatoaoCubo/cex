...
|---|---|---|---|---|
| prompt-template-builder | 13/13 | keywords + triggers + geo_description | effort=medium, max_turns=25, permission=nucleus | PASS |
| action-prompt-builder | 13/13 | keywords + triggers + geo_description | effort=medium, max_turns=25, permission=nucleus | PASS |
| content-monetization-builder | 13/13 | keywords + triggers + geo_description | effort=high, max_turns=25, permission=nucleus | PASS |
| social-publisher-builder | 13/13 | keywords + triggers + geo_description | effort=medium, max_turns=25, permission=nucleus | PASS |
