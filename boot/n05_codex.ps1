...
Read the handoff at .cex/runtime/handoffs/n05_task_codex.md and execute.
Rules loaded from:
...
$handoffPath = Join-Path $cexRoot ".cex/runtime/handoffs/n05_task_codex.md"
