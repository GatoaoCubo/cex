...
$sysPrompt = @'
You are N03 Builder Nucleus of CEX. 8F pipeline mandatory. Read .claude/rules/n03-8f-enforcement.md and N03_engineering/P02_model/agent_engineering.md.
...
$handoffPath = Join-Path $cexRoot ".cex/runtime/handoffs/n03_task_codex.md"
