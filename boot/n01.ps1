...
# isolation: worktree
# permissions: .claude/nucleus-settings/n01.json (auto-loaded if present)
...
$cliArgs = @("--dangerously-skip-permissions", "--permission-mode", "bypassPermissions", "--no-chrome", "--model", "claude-sonnet-4-6", "--name", "CEX-N01")
