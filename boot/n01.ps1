...
Write-Host ""
Write-Host "  N01 RESEARCH  |  claude-opus-4-6  |  1000K context" -ForegroundColor Cyan
...
claude --dangerously-skip-permissions --permission-mode bypassPermissions --no-chrome --model claude-opus-4-6 --mcp-config "C:\Users\PC\Documents\GitHub\cex\.mcp-n01.json" --settings "C:\Users\PC\Documents\GitHub\cex\.claude/nucleus-settings/n01.json" "Voce e N01 Research Nucleus do CEX. Dominio: research, analise, papers, competidores. SE EXISTIR .cex/runtime/handoffs/n01_task.md LEIA E EXECUTE IMEDIATAMENTE."
