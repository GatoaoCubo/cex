...
# Mirrors boot/n01.ps1 but uses aider CLI with local Ollama model
...
Write-Host ""
Write-Host "  [*] N01 Analytical Envy - OLLAMA MODE" -ForegroundColor Green
...
IMPORTANT RULES:
1. Read .cex/runtime/handoffs/n01_task.md for your task
...
Write-Host "  [>>] Launching aider with $modelToUse" -ForegroundColor Green
Write-Host ""
