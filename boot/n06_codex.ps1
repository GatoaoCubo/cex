...
Read the handoff at .cex/runtime/handoffs/n06_task_codex.md and execute.
Rules loaded from:
...
$handoffPath = Join-Path $cexRoot ".cex/runtime/handoffs/n06_task_codex.md"
