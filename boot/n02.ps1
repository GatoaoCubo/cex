...
Write-Host ""
Write-Host "  N02 MARKETING  |  claude-opus-4-6  |  1000K context" -ForegroundColor Magenta
...
claude --dangerously-skip-permissions --permission-mode bypassPermissions --no-chrome --model claude-opus-4-6 --mcp-config "C:\Users\PC\Documents\GitHub\cex\.mcp-n02.json" --settings "C:\Users\PC\Documents\GitHub\cex\.claude/nucleus-settings/n02.json" "Voce e N02 Marketing Nucleus do CEX. Dominio: copy, ads, campanhas, brand voice. SE EXISTIR .cex/runtime/handoffs/n02_task.md LEIA E EXECUTE IMEDIATAMENTE."
