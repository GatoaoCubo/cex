...
$cliArgs = @("--dangerously-skip-permissions", "--permission-mode", "bypassPermissions", "--no-chrome", "--model", "claude-sonnet-4-6", "--name", "CEX-N02")
...
$args += "--mcp-config", "C:\Users\CEX\Documents\GitHub\cex\.mcp-n02.json"
$args += "--settings", "C:\Users\CEX\Documents\GitHub\cex\.claude/nucleus-settings/n02.json"
$cliArgs += $initialMsg
