...
5. After writing, compile: python _tools/cex_compile.py N01_intelligence/research/atlas/$file
...
## ON COMPLETION
1. Commit your work: git add N01_intelligence/research/atlas/$file N01_intelligence/research/compiled/ && git commit -m "[N01-ATLAS] hydrate atom_$id $topic"
2. Signal complete:
