...
# chrome: enabled (claude-in-chrome) -- browser_tool + computer_use for UI automation
...
Write-Host "  claude-opus-4-6  |  1M context  |  8F pipeline  |  chrome-enabled" -ForegroundColor DarkGray
...
$cliArgs = @("--dangerously-skip-permissions", "--permission-mode", "bypassPermissions", "--model", "claude-opus-4-6", "--name", "CEX-N05")
...
$cliArgs += "--mcp-config", "C:\Users\CEX\Documents\GitHub\cex\.mcp-n05.json"
$cliArgs += "--settings", "C:\Users\CEX\Documents\GitHub\cex\.claude/nucleus-settings/n05.json"
$cliArgs += $initialMsg
