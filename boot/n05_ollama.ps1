...
# Mirrors boot/n05.ps1 but uses aider CLI with local Ollama model
...
Write-Host ""
Write-Host "  [*] N05 Gating Wrath - OLLAMA MODE" -ForegroundColor Red
...
Write-Host "  [>>] Launching aider with $modelToUse" -ForegroundColor Red
Write-Host ""
