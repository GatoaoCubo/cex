...
Read the handoff at .cex/runtime/handoffs/n01_task_gemini.md and execute.
Rules loaded from:
...
$handoffPath = Join-Path $cexRoot ".cex/runtime/handoffs/n01_task_gemini.md"
