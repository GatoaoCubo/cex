...
# Mirrors boot/n03.ps1 but uses aider CLI with local Ollama model
...
IMPORTANT RULES:
1. Read .cex/runtime/handoffs/n03_task.md for your task
...
Write-Host "  [>>] Launching aider with $modelToUse" -ForegroundColor Blue
Write-Host ""
