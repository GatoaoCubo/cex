...
$cexModel = if ($env:CEX_CLAUDE_MODEL) { $env:CEX_CLAUDE_MODEL } else { "claude-opus-4-6" }
$cliArgs = @("--dangerously-skip-permissions", "--permission-mode", "bypassPermissions", "--no-chrome", "--model", $cexModel, "--name", "CEX-N03")
