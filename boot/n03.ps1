...
$cliArgs = @("--dangerously-skip-permissions", "--permission-mode", "bypassPermissions", "--no-chrome", "--model", "claude-opus-4-6", "--name", "CEX-N03")
...
$cliArgs += "--mcp-config", (Join-Path $cexRoot ".mcp-n03.json")
$cliArgs += "--settings", (Join-Path $cexRoot ".claude/nucleus-settings/n03.json")
$cliArgs += $initialMsg
