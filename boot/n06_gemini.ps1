...
$sysPrompt = @'
You are N06 Commercial Nucleus of CEX. Domain: pricing, funnels, monetization, brand. IF .cex/runtime/handoffs/n06_task.md EXISTS, READ AND EXECUTE IMMEDIATELY.

You are running via GEMINI CLI in CEX multi-CLI test mode.
Read the handoff at .cex/runtime/handoffs/n06_task_gemini.md and execute.
Rules loaded from:
...
$handoffPath = Join-Path $cexRoot ".cex/runtime/handoffs/n06_task_gemini.md"
