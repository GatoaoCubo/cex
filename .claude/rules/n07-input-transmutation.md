...
holds the multilingual pattern table for all 300 kinds + verb resolution + ambiguity rules (EN-first,
community languages extensible -- PT-BR seeded as first community contribution). The tables below
in this rule are an N07-curated **summary** -- when a kind is missing here, defer to the prompt_compiler
artifact (it is the source of truth, version-controlled, peer-scored). The legacy
...
### P11 Feedback (HERMES additions)
| User says | N07 maps to |
|-----------|-------------|
| "max tentativas" / "revision policy" | kind: revision_loop_policy, pillar: P11, nucleus: N05 (HERMES) |
| "nudge" / "lembrete persistir" / "curation prompt" | kind: curation_nudge, pillar: P11, nucleus: N04 (HERMES) |

### P12 Orchestration (HERMES additions)
| User says | N07 maps to |
|-----------|-------------|
| "pipeline cenario" / "bug-fix pipeline" / "refactor pipeline" | kind: pipeline_template, pillar: P12, nucleus: N07 (OpenCode-Hermes) |

### P04 Tools (HERMES additions)
| User says | N07 maps to |
|-----------|-------------|
| "messaging gateway" / "bot multiplataforma" / "telegram discord slack" | kind: messaging_gateway, pillar: P04, nucleus: N05 (HERMES) |

### P03 Prompt (HERMES additions)
| User says | N07 maps to |
|-----------|-------------|
| "context file" / "arquivo contexto" / "workspace instructions" | kind: context_file, pillar: P03, nucleus: N03 (HERMES) |

### P02 Model (HERMES additions)
| User says | N07 maps to |
|-----------|-------------|
| "personality" / "persona" / "trocar persona" | kind: personality, pillar: P02, nucleus: N03 (HERMES SOUL.md) |
...
| "terminal backend" / "backend execucao" / "daytona/modal/singularity" | kind: terminal_backend, pillar: P09, nucleus: N05 (HERMES) |
| "hibernar" / "idle cost" / "hibernation policy" | kind: hibernation_policy, pillar: P09, nucleus: N05 (HERMES) |
...
| "remember me" / "perfil do usuario" / "lembrar preferencias" | kind: user_model, pillar: P10, nucleus: N04 (HERMES Honcho) |
...
## Verb Resolution (Multilingual)

N07 maps user verbs to canonical actions in any language. These inform which 8F functions to emphasize.

| Community Verb (e.g. PT-BR) | EN Verb | Canonical Action | Primary 8F Function |
|---------|---------|-----------------|---------------------|
...
| F2 BECOME | Load builder (12 ISOs, 1:1 pillars) | Include builder path in handoff |
...
|----------|-------------|-------|
| [[p01_kc_prompt_compiler]] | related | 0.43 |
| [[p03_ins_prompt_compiler]] | related | 0.40 |
| [[quality_gate_intent_resolution]] | related | 0.37 |
| [[prompt-compiler-builder]] | related | 0.37 |
| [[p03_sp_prompt_compiler_builder]] | related | 0.37 |
| [[bld_architecture_prompt_compiler]] | related | 0.33 |
| [[p01_kg_cex_system_architecture]] | related | 0.33 |
| [[bld_knowledge_card_nucleus_def]] | related | 0.31 |
| [[bld_collaboration_prompt_compiler]] | related | 0.31 |
| [[p08_pat_nucleus_fractal]] | related | 0.31 |
