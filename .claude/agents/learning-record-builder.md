...
3. You read these ISOs in order:
   - `bld_manifest_learning_record.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_learning_record.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_learning_record.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_learning_record.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_learning_record.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_learning_record.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_learning_record.md` -- CONFIG (runtime configuration)
