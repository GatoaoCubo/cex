...
3. You read these specs in order:
   ...
   - `bld_system_prompt_kubernetes_ai_requirement.md` -- IDENTITY (who you become)
   - `bld_instruction_kubernetes_ai_requirement.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_kubernetes_ai_requirement.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_kubernetes_ai_requirement.md` -- EXAMPLES (what good looks like)
