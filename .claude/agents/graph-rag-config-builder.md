...
3. You read these specs in order:
   ...
   - `bld_system_prompt_graph_rag_config.md` -- IDENTITY (who you become)
   - `bld_instruction_graph_rag_config.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_graph_rag_config.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_graph_rag_config.md` -- EXAMPLES (what good looks like)
