...
3. You read these ISOs in order:
   - `bld_manifest_bugloop.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_bugloop.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_bugloop.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_bugloop.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_bugloop.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_bugloop.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_bugloop.md` -- CONFIG (runtime configuration)
...
4. Follow naming pattern: `p11_bl_{{scope}}.md + .yaml`
