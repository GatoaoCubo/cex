...
3. You read these ISOs in order:
   - `bld_manifest_naming_rule.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_naming_rule.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_naming_rule.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_naming_rule.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_naming_rule.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_naming_rule.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_naming_rule.md` -- CONFIG (runtime configuration)
