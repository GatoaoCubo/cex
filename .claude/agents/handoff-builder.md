...
description: "Builds ONE handoff artifact via 8F pipeline. Loads handoff-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
...
4. Follow naming pattern: `p12_ho_{{task}}.md`
...
F2 BECOME: handoff-builder ISOs loaded
