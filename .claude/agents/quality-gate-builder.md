...
description: "Builds ONE quality_gate artifact via 8F pipeline. Loads quality-gate-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
tools: Read, Write, Edit, Bash, Glob, Grep
quality: 9.0
title: "Quality-Gate-Builder"
version: "1.0.0"
author: n03_builder
...
4. Follow naming pattern: `p11_qg_{{gate}}.yaml`
...
F2 BECOME: quality-gate-builder ISOs loaded
