...
3. You read these specs in order:
   ...
   - `bld_system_prompt_subscription_tier.md` -- IDENTITY (who you become)
   - `bld_instruction_subscription_tier.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_subscription_tier.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_subscription_tier.md` -- EXAMPLES (what good looks like)
