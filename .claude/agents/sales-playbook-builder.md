...
3. You read these specs in order:
   ...
   - `bld_system_prompt_sales_playbook.md` -- IDENTITY (who you become)
   - `bld_instruction_sales_playbook.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_sales_playbook.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_sales_playbook.md` -- EXAMPLES (what good looks like)
