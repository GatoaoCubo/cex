...
3. You read these specs in order:
   ...
   - `bld_system_prompt_ab_test_config.md` -- IDENTITY (who you become)
   - `bld_instruction_ab_test_config.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_ab_test_config.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_ab_test_config.md` -- EXAMPLES (what good looks like)
