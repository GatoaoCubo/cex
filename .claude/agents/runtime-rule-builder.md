...
description: "Builds ONE runtime_rule artifact via 8F pipeline. Loads runtime-rule-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
tools: Read, Write, Edit, Bash, Glob, Grep
quality: 9.0
title: "Runtime-Rule-Builder"
version: "1.0.0"
author: n03_builder
...
4. Follow naming pattern: `p09_rr_{{rule}}.yaml`
...
F2 BECOME: runtime-rule-builder ISOs loaded
