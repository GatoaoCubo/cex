...
3. You read these ISOs in order:
   - `bld_manifest_path_config.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_path_config.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_path_config.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_path_config.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_path_config.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_path_config.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_path_config.md` -- CONFIG (runtime configuration)
...
4. Follow naming pattern: `p09_path_{{scope}}.yaml`
