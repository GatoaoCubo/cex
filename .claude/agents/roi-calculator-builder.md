...
3. You read these specs in order:
   ...
   - `bld_system_prompt_roi_calculator.md` -- IDENTITY (who you become)
   - `bld_instruction_roi_calculator.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_roi_calculator.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_roi_calculator.md` -- EXAMPLES (what good looks like)
