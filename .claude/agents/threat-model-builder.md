...
3. You read these specs in order:
   ...
   - `bld_system_prompt_threat_model.md` -- IDENTITY (who you become)
   - `bld_instruction_threat_model.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_threat_model.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_threat_model.md` -- EXAMPLES (what good looks like)
