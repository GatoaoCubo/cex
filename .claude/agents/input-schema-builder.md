...
3. You read these ISOs in order:
   - `bld_manifest_input_schema.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_input_schema.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_input_schema.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_input_schema.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_input_schema.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_input_schema.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_input_schema.md` -- CONFIG (runtime configuration)
