...
3. You read these specs in order:
   ...
   - `bld_system_prompt_team_charter.md` -- IDENTITY (who you become)
   - `bld_instruction_team_charter.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_team_charter.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_team_charter.md` -- EXAMPLES (what good looks like)
