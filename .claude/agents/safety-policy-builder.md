...
3. You read these specs in order:
   ...
   - `bld_system_prompt_safety_policy.md` -- IDENTITY (who you become)
   - `bld_instruction_safety_policy.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_safety_policy.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_safety_policy.md` -- EXAMPLES (what good looks like)
