...
3. You read these specs in order:
   ...
   - `bld_system_prompt_contributor_guide.md` -- IDENTITY (who you become)
   - `bld_instruction_contributor_guide.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_contributor_guide.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_contributor_guide.md` -- EXAMPLES (what good looks like)
