...
3. You read these ISOs in order:
   - `bld_manifest_content_monetization.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_content_monetization.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_content_monetization.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_content_monetization.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_content_monetization.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_content_monetization.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_content_monetization.md` -- CONFIG (runtime configuration)
