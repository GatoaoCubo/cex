---
name: plugin-builder
description: "Builds ONE plugin artifact via 8F pipeline. Loads plugin-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
...
4. Follow naming pattern: `p04_plug_{{name}}.md + .yaml`
...
F2 BECOME: plugin-builder ISOs loaded
