...
3. You read these specs in order:
   ...
   - `bld_system_prompt_product_tour.md` -- IDENTITY (who you become)
   - `bld_instruction_product_tour.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_product_tour.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_product_tour.md` -- EXAMPLES (what good looks like)
