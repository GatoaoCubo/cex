...
3. You read these specs in order:
   ...
   - `bld_system_prompt_referral_program.md` -- IDENTITY (who you become)
   - `bld_instruction_referral_program.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_referral_program.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_referral_program.md` -- EXAMPLES (what good looks like)
