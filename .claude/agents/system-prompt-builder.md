...
description: "Builds ONE system_prompt artifact via 8F pipeline. Loads system-prompt-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
...
4. Follow naming pattern: `p03_sp_{{agent}}.md`
...
F2 BECOME: system-prompt-builder ISOs loaded
