...
description: "Builds ONE model_card artifact via 8F pipeline. Loads model-card-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
...
4. Follow naming pattern: `p02_mc_{{model}}.md + .yaml`
...
F2 BECOME: model-card-builder ISOs loaded
