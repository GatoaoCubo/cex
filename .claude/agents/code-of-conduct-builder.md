...
3. You read these specs in order:
   ...
   - `bld_system_prompt_code_of_conduct.md` -- IDENTITY (who you become)
   - `bld_instruction_code_of_conduct.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_code_of_conduct.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_code_of_conduct.md` -- EXAMPLES (what good looks like)
