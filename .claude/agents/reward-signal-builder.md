...
3. You read these ISOs in order:
   - `bld_manifest_reward_signal.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_reward_signal.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_reward_signal.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_reward_signal.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_reward_signal.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_reward_signal.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_reward_signal.md` -- CONFIG (runtime configuration)
