...
3. You read these specs in order:
   ...
   - `bld_system_prompt_memory_architecture.md` -- IDENTITY (who you become)
   - `bld_instruction_memory_architecture.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_memory_architecture.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_memory_architecture.md` -- EXAMPLES (what good looks like)
