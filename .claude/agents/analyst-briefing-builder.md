...
3. You read these specs in order:
   ...
   - `bld_system_prompt_analyst_briefing.md` -- IDENTITY (who you become)
   - `bld_instruction_analyst_briefing.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_analyst_briefing.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_analyst_briefing.md` -- EXAMPLES (what good looks like)
