...
3. You read these ISOs in order:
   - `bld_manifest_effort_profile.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_effort_profile.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_effort_profile.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_effort_profile.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_effort_profile.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_effort_profile.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_effort_profile.md` -- CONFIG (runtime configuration)
