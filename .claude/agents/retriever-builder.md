...
description: "Builds ONE retriever artifact via 8F pipeline. Loads retriever-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
tools: Read, Write, Edit, Bash, Glob, Grep
quality: 9.0
title: "Retriever-Builder"
version: "1.0.0"
author: n03_builder
...
4. Follow naming pattern: `p04_retr_{{store}}.md + .yaml`
...
F2 BECOME: retriever-builder ISOs loaded
