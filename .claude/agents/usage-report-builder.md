...
3. You read these specs in order:
   ...
   - `bld_system_prompt_usage_report.md` -- IDENTITY (who you become)
   - `bld_instruction_usage_report.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_usage_report.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_usage_report.md` -- EXAMPLES (what good looks like)
