...
3. You read these specs in order:
   ...
   - `bld_system_prompt_changelog.md` -- IDENTITY (who you become)
   - `bld_instruction_changelog.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_changelog.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_changelog.md` -- EXAMPLES (what good looks like)
