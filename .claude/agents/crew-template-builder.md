...
3. You read these specs in order:
   ...
   - `bld_system_prompt_crew_template.md` -- IDENTITY (who you become)
   - `bld_instruction_crew_template.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_crew_template.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_crew_template.md` -- EXAMPLES (what good looks like)
