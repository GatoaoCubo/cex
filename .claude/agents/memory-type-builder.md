...
3. You read these specs in order:
   - `bld_manifest_memory_type.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_memory_type.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_memory_type.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_memory_type.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_memory_type.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_memory_type.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_memory_type.md` -- CONFIG (runtime configuration)
