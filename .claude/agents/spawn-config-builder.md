...
3. You read these ISOs in order:
   - `bld_manifest_spawn_config.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_spawn_config.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_spawn_config.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_spawn_config.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_spawn_config.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_spawn_config.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_spawn_config.md` -- CONFIG (runtime configuration)
