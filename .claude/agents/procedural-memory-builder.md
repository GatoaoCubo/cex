...
3. You read these specs in order:
   ...
   - `bld_system_prompt_procedural_memory.md` -- IDENTITY (who you become)
   - `bld_instruction_procedural_memory.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_procedural_memory.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_procedural_memory.md` -- EXAMPLES (what good looks like)
