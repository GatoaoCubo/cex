...
3. You read these specs in order:
   ...
   - `bld_system_prompt_press_release.md` -- IDENTITY (who you become)
   - `bld_instruction_press_release.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_press_release.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_press_release.md` -- EXAMPLES (what good looks like)
