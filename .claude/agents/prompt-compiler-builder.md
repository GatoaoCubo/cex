...
3. You read these ISOs in order:
   - `bld_manifest_prompt_compiler.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_prompt_compiler.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_prompt_compiler.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_prompt_compiler.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_prompt_compiler.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_prompt_compiler.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_prompt_compiler.md` -- CONFIG (runtime configuration)
