...
3. You read these ISOs in order:
   - `bld_manifest_checkpoint.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_checkpoint.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_checkpoint.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_checkpoint.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_checkpoint.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_checkpoint.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_checkpoint.md` -- CONFIG (runtime configuration)
