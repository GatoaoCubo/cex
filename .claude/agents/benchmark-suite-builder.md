...
3. You read these specs in order:
   ...
   - `bld_system_prompt_benchmark_suite.md` -- IDENTITY (who you become)
   - `bld_instruction_benchmark_suite.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_benchmark_suite.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_benchmark_suite.md` -- EXAMPLES (what good looks like)
