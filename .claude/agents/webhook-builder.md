...
description: "Builds ONE webhook artifact via 8F pipeline. Loads webhook-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
...
4. Follow naming pattern: `p04_webhook_{{event}}.md + .json`
...
F2 BECOME: webhook-builder ISOs loaded
