...
description: "Builds ONE formatter artifact via 8F pipeline. Loads formatter-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
tools: Read, Write, Edit, Bash, Glob, Grep
quality: 9.0
title: "Formatter-Builder"
version: "1.0.0"
author: n03_builder
...
4. Follow naming pattern: `p05_fmt_{{format}}.md`
...
F2 BECOME: formatter-builder ISOs loaded
