...
description: "Builds ONE citation artifact via 8F pipeline. Loads citation-builder ISOs. Produces draft with frontmatter + body. Never self-scores quality."
model: sonnet
...
2. You load builder ISOs from `archetypes/builders/citation-builder/`
3. You read these ISOs in order:
   - `bld_manifest_citation.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_citation.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_citation.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_citation.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_citation.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_citation.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_citation.md` -- CONFIG (runtime configuration)
...
4. Follow naming pattern: `p01_cit_{{topic}}.md`
...
F2 BECOME: citation-builder ISOs loaded
