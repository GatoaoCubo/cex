...
quality: 9.0
title: "Workflow-Primitive-Builder"
version: "1.0.0"
author: n03_builder
...
3. You read these specs in order:
   - `bld_manifest_workflow_primitive.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_workflow_primitive.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_workflow_primitive.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_workflow_primitive.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_workflow_primitive.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_workflow_primitive.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_workflow_primitive.md` -- CONFIG (runtime configuration)
...
| Aspect | Value |
|--------|-------|
| Agent | `workflow-primitive-builder` |
| Domain | CEX system |
