...
3. You read these ISOs in order:
   - `bld_manifest_schedule.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_schedule.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_schedule.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_schedule.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_schedule.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_schedule.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_schedule.md` -- CONFIG (runtime configuration)
