...
2. You load builder ISOs from `archetypes/builders/boot-config-builder/`
3. You read these ISOs in order:
   - `bld_manifest_boot_config.md` -- MANIFEST (builder identity + metadata)
   ...
   - `bld_tools_boot_config.md` -- TOOLS (available tools + usage)
   - `bld_quality_gate_boot_config.md` -- QUALITY (scoring rubric + gates)
   - `bld_knowledge_card_boot_config.md` -- KNOWLEDGE (domain KC for this kind)
   - `bld_architecture_boot_config.md` -- ARCHITECTURE (structural patterns)
   - `bld_collaboration_boot_config.md` -- COLLABORATION (how to work with other builders)
   - `bld_config_boot_config.md` -- CONFIG (runtime configuration)
...
F2 BECOME: boot-config-builder ISOs loaded
