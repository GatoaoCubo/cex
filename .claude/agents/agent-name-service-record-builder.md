...
3. You read these specs in order:
   ...
   - `bld_system_prompt_agent_name_service_record.md` -- IDENTITY (who you become)
   - `bld_instruction_agent_name_service_record.md` -- PROCESS (research > compose > validate)
   - `bld_output_template_agent_name_service_record.md` -- TEMPLATE (the shape to fill)
   - `bld_examples_agent_name_service_record.md` -- EXAMPLES (what good looks like)
