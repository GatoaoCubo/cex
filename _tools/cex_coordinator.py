...
from cex_agent_spawn import (
    get_spawner, SpawnMode, Isolation,
    TaskNotification, AgentSpawner,
)
    ...
    def research_phase(
        ...
        for task in tasks:
            ...
            spec = (
                ...
                f"{task['spec']}\n\n"
                f"Report: findings, specific file paths, line numbers, types involved."
            )
    ...
    def implement_phase(
        ...
        for spec in impl_specs:
            ...
            if lazy:
                ...
                print(f"[COORDINATOR] Rewrite the spec with specific files, lines, and changes.")
            ...
            impl_spec = (
                ...
                f"{spec_text}\n\n"
                f"After completing, run relevant tests and commit your changes. "
    ...
    def verify_phase(
        ...
        for task in verify_tasks:
            spec = (
                ...
                f"Try edge cases and error paths."
            )
            wid = self.spawner.spawn(
                nucleus=task["nucleus"],
                task_spec=spec,
