...
def test_memory_scanner_returns_headers():
    from cex_memory import scan_builder_memories, MemoryHeader
...
def test_memory_selector_keyword_fallback():
    from cex_memory_select import select_relevant_memories, SelectedMemory
...
def test_memory_injection_format():
    from cex_memory_select import format_memory_injection, SelectedMemory
...
def test_memory_update_functions():
    from cex_memory_update import apply_decay, append_observation, prune_low_confidence
