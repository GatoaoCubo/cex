...
is invoked. For 124 builders x 13 ISOs = 1612 file reads per full grid pass.
...
def compile_builder(kind: str) -> dict[str, Any] | None:
    ...
    for iso_path in iso_files:
        try:
            ...
            # Derive section name from filename: bld_instruction_agent.md -> instruction
            stem = iso_path.stem  # bld_instruction_agent
