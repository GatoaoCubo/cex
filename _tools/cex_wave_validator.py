...
DOMAIN_KEYWORDS: dict[str, list[str]] = {
    ...
    "type_de":            ["type", "definition", "field"],
    "interface":           ["interface", "contract", "method"],
    "enum_de":            ["enum", "variant", "value"],
    "function_de":        ["function", "parameter", "return"],
    ...
    "handof":             ["handof", "transfer", "context"],
    "handoff_protocol":    ["handof", "protocol", "transfer"],
