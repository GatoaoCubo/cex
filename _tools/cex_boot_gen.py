...
def build_claude_ps1(nucleus: str, cfg: dict, meta: dict) -> str:
    ...
    colors = NUCLEUS_COLORS.get(nucleus, NUCLEUS_COLORS["n03"])
...
Write-Host ""
Write-Host "  {nucleus.upper()} {colors['label']}  |  {model}  |  {ctx // 1000}K context" -ForegroundColor {colors["accent"]}
...
claude {flags} --model {model} {mcp_arg} {settings_arg} "{meta["prompt"]}"
'''
