...
PILLAR_DESCRIPTIONS = {
    "P01": "What the agent KNOWS",
    "P02": "WHO the agent IS",
    "P03": "HOW the agent SPEAKS",
    "P04": "What the agent USES",
    "P05": "What the agent DELIVERS",
    "P06": "Validation CONTRACTS",
    "P07": "HOW to measure quality",
    "P08": "HOW it scales",
    "P09": "HOW it configures",
    "P10": "What it REMEMBERS",
    "P11": "HOW it improves",
    "P12": "HOW it coordinates",
}
...
def interactive_flow() -> dict:
    ...
    print("    Agent count: 1=minimal, 3=starter, 7=full, or a number")
...
## VARIAVEIS
- {{{{MUSTACHE}}}} = template engine resolves at generation time
...
|-------|----------|----------|
| L0 DNA | `archetypes/builders/{{type}}-builder/` | 12 builder specs per builder |
...
```
bld_  = builder (L0)     | bld_model_agent.md
...
{name}/
  archetypes/          # CODEX + builders (DNA layer)
    builders/          # {builders} builder(s) with 12 builder specs each
...
def scaffold(cfg: dict) -> None:
    ...
    print("  python _tools/cex_doctor.py")
    print("=" * 60)
