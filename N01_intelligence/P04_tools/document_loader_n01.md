...
|----------|-------------|
| `P04_tools/search_strategy_n01.md` | provides URLs for this loader |
| `P06_schema/sch_type_def_n01.md` | defines DocumentChunk type |
| `P04_tools/research_pipeline_n01.md` | consumes loaded chunks |
| `P10_memory/knowledge_index_n01.md` | indexes chunks for future retrieval |
