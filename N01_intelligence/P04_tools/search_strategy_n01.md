...
|----------|-------------|
| `P06_schema/api_reference_research_apis.md` | API contracts for each source |
| `P04_tools/research_pipeline_n01.md` | orchestration layer using this strategy |
| `P04_tools/document_loader_n01.md` | loads documents found by this strategy |
| `P07_evals/eval_framework_n01.md` | evaluates search quality |
| `P11_feedback/bias_audit_n01.md` | audits search bias (selection, recency) |
