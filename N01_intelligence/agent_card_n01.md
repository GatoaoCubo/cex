...
**Comparative positioning**: N01 has 66 source artifacts, 3 agents, 4 tool configs, and 5 quality artifacts (including benchmark + eval dataset). N01 matches N05's infrastructure maturity while maintaining unique depth in external research via 5 MCP servers and 6 schema contracts.
...
| reports | 3 | Self-audit reports, taxonomy audit, token efficiency map |
| **TOTAL** | **66** | |
...
| Category | Count |
|----------|------:|
| Artifacts in N01_intelligence/ | 66 |
