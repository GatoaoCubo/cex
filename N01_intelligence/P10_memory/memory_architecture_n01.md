...
| Artifact | Layer |
|----------|-------|
| `P10_memory/knowledge_index_n01.md` | L3 index |
| `P10_memory/entity_memory_n01.md` | L3 entities |
| `P10_memory/mem_memory_summary_n01.md` | L1->L2 summarizer |
| `P03_prompt/reasoning_strategy_n01.md` | L4 procedural |
| `P04_tools/retriever_n01.md` | L3 retrieval engine |
