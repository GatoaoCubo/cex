...
|----------|-------------|
| `P07_evals/eval_framework_n01.md` | evaluation protocol used in B3 |
| `P07_evals/llm_judge_n01.md` | judge used for B3, B4 assessment |
| `P07_evals/p07_benchmark_research_quality.md` | predecessor, single benchmark |
| `P11_feedback/regression_check_n01.md` | detects benchmark regressions |
