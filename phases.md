...
type: kind
pillar: P04
title: "Phases — Structured Workflow Execution for skill artifacts"
version: 1.0.0
created: 2026-04-02
updated: 2026-04-02
...
domain: skill
quality: 9.1
tags: [skill, p04, workflow, phases, kind-kc]
tldr: "Reusable workflow framework with structured phases, trigger conditions, and lifecycle management for repeatable execution"
...
## What It Is
A phase is a structured workflow component that defines the sequence of operations for executing a skill. It provides a framework for organizing tasks into logical steps with defined inputs and outputs. Phases enable modular, reusable execution patterns that can be combined to create complex workflows. Skills are NOT agents (P02, which define identity/persona) nor system_prompts (P03, which define communication style). A skill answers "what phases execute to achieve this capability?" while agents answer "who am I?" and prompts answer "how do I communicate?"
