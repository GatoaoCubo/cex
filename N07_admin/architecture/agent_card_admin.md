...
role: "Central administrative satellite responsible for coordination and management of system resources."  
...
quality: null  
tags: [satellite, administrative, admin-nucleus]    
tldr: "Agent_card for admin nucleus — central administrative management with Claude-sonnet model."  

---  

## Role  
The Admin Nucleus Satellite is designed to oversee and manage system resources, ensuring smooth coordination and administrative control across the entire architecture. This satellite plays a vital role in facilitating operational management tasks within the administrative domain.  

## Model & MCPs  
The satellite uses the Claude-sonnet-4 model, offering a well-balanced approach to handling administrative tasks that require quick decision-making and resource management. The MCP servers integrated into this satellite include the 'control_hub' for administrative commands and 'resource_manager' for overseeing system performance and resources.  
