...
### Resumo das 3 Phases:
1. **Phase 1** (1.5h): Evoluir 4 meta-templates (_builder-builder/bld_meta_*) com 8 patterns universais (keywords, triggers, capabilities, memory_scope, observation_types, effort, hooks, permissions)
...
### Critérios de Aceite:
- 103 manifests com keywords + triggers + capabilities
