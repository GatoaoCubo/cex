...
```bash
# Validate single KC
python _tools/kc_validator.py validate path/to/kc.md

# Validate all KCs in a directory
python _tools/kc_validator.py validate P01_knowledge/library/kind/ --recursive
...
| **Section order** | H1 → Core → Tables → CEX Integration | Minor |
...
[FAIL] path/to/bad_kc.md
  ✗ CRITICAL: missing frontmatter field 'tldr'
  ✗ MAJOR: density 0.71 (below 0.80 threshold)
  ✗ MINOR: section order violation (Tables before Core)
...
| 8F F7 gate | `cex_score.py --pre-check` | Block publish below threshold |
...
|----------|-------------|-------|
| [[p11_qg_knowledge]] | downstream | 0.33 |
| [[validate]] | downstream | 0.27 |
| [[p03_sp_kc_auditor]] | upstream | 0.26 |
| [[p11_qg_artifact]] | downstream | 0.24 |
| [[output_kc_quality_audit_20260408]] | upstream | 0.22 |
| [[bld_examples_validator]] | downstream | 0.21 |
| [[p04_ct_validate_builder]] | sibling | 0.21 |
| [[p05_rf_builder_artifact]] | downstream | 0.20 |
| [[p04_skill_verify]] | related | 0.20 |
| [[p03_sp_verification_agent]] | upstream | 0.20 |
